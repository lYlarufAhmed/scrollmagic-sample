            ...
            >
              {progress => (
                <Tween
                  ...
                  paused
                >
                  <div className="section-border section-border-right h-full w-5 lg:w-20 bg-white absolute right-0 bottom-0" />
                </Tween>
              )}
            </Scene>
          </Controller>
        ...
        <div className="lg:p-12 text-left step">
          <OnVisible className="in-view">
            ...
            <p className="text-left text-white pb-6">
              ...
              at elementum elit purus placerat ante. Lorem ipsum dolor sit amet,
              consectetur adipiscing elit. Donec ac diam mattis, posuere nunc
              sit amet, pulvinar ipsum. Vestibulum mattis, felis egestas sodales
              viverra, eros justo rhoncus metus, at elementum elit purus
              placeratante.,
            </p>
            <a
              className="bg-purple-600 hover:shadow-md text-white text-xs text-left font-bold py-2 px-4 rounded-full"
              href="0#"
            >
              Learn more
            </a>
